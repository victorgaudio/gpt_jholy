...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "JholyGPT funciona com vários provedores de LLM. Este será o serviço que lidará com os chats.",
    },
    userSetup: {
    ...
    survey: {
      title: "Bem-vindo ao JholyGPT",
      description: "Ajude-nos a melhorar o JholyGPT. Opcional.",
      email: "Qual seu email?",
      useCase: "Como você usará o JholyGPT?",
      useCaseWork: "Para trabalho",
      useCasePersonal: "Uso pessoal",
      useCaseOther: "Outro",
      comment: "Como você conheceu o JholyGPT?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description: "Crie seu primeiro workspace e comece a usar o JholyGPT.",
    },
  },
  common: {
  ...
  welcomeMessage: {
    part1:
      "Bem-vindo ao JholyGPT, uma ferramenta de IA open-source que transforma qualquer conteúdo em um chatbot treinado. JholyGPT é um software BYOK (bring-your-own-keys), sem taxas ou assinaturas.",
    part2:
      "JholyGPT é a maneira mais fácil de integrar poderosas ferramentas de IA como OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB e outros serviços em um pacote simples.",
    part3:
      "JholyGPT pode rodar localmente na sua máquina com baixo consumo de recursos. Sem GPU necessária. Disponível para instalação na nuvem ou on-premises.\nO ecossistema de IA evolui rapidamente. JholyGPT facilita seu uso.",
  ...
  general: {
    ...
    message: {
      ...
      body: "os benefícios do JholyGPT",
    },
    pfp: {
  ...
  customization: {
    ...
    branding: {
      ...
      description: "Personalize sua instância do JholyGPT com sua marca.",
    },
    chat: {
      title: "Chat",
  ...
  transcription: {
    ...
    "warn-start":
      "Usar o modelo local whisper em máquinas com RAM ou CPU limitada pode travar o JholyGPT.",
  ...
  privacy: {
    ...
    description:
      "Configurações de como provedores terceiros e o JholyGPT lidam com seus dados.",
    llm: "Seleção de LLM",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Esses arquivos são enviados ao processador local do JholyGPT. Não são compartilhados com terceiros.",
    },
    pinning: {
